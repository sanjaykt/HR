        ...
        child: Container(
          ...
          child: ListView(
            children: [
              ...
              Text('Teaching Hours Per Week', textAlign: TextAlign.center, style: TextStyle(fontSize: 16)),
              ...
              SizedBox(height: 30),
              Text('Research Hours Per Week', textAlign: TextAlign.center, style: TextStyle(fontSize: 16)),
              SingleChildScrollView(
                scrollDirection: Axis.horizontal,
                child: DataTable(columns: <DataColumn>[
                  DataColumn(label: Text('Weeks')),
              ...
              SizedBox(height: 30),
              Text('Admin Hours Per Week', textAlign: TextAlign.center, style: TextStyle(fontSize: 16)),
              SingleChildScrollView(
                scrollDirection: Axis.horizontal,
                child: DataTable(columns: <DataColumn>[
                  DataColumn(label: Text('Weeks')),
